RSpec.describe Peatio::Bouwgeld::Wallet do
  let(:wallet) { Peatio::Bouwgeld::Wallet.new }
  ...
  context :configure do
    let(:unconfigured_wallet) { Peatio::Bouwgeld::Wallet.new }
    ...
    it 'sets settings attribute' do
      ...
      expect(unconfigured_wallet.settings).to eq(settings.slice(*Peatio::Bouwgeld::Wallet::SUPPORTED_SETTINGS))
    end
  end
